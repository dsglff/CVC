...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='ETTh2_CVC_512_96', help='model id')
    parser.add_argument('--model', type=str, default='CVC',
    ...
    parser.add_argument('--sim_coef', type=float, default=-0.05)
...
# prompt设置
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_gpt{}_{}_{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
